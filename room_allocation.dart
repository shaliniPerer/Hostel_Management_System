...
import 'package:hostel/notifications.dart';
import 'package:hostel/rooms/QR_Code.dart';
import 'package:hostel/rooms/add_student.dart';
import 'package:hostel/rooms/room_details.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            buildAnimatedButton(
              text: 'QR Code',
              color: Colors.blue,
              onPressed: () => _navigateToQrCode(context),
              heroTag: 'QRCode',
            ),
          ],
        ),
